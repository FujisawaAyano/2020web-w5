...
let storyText = '外は華氏94度もあったので体重が300ポンドある:insertx:たちは散歩に出かけました。彼らが:inserty:に到着した時、彼らはとても驚きました。なぜなら:insertz:からです。しかしボブはそれを見ても驚くことはありませんでした。それは:insert:ではよく起きる事だからです。';
